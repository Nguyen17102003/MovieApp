    ...
    backgroundImage: movie?.backdrop_path
      ...
      : "none"
        ...
        <div className='hidden w-full md:basis-1/3 z-30 md:px-2 xl:px-4 md:flex'>
            <img src={`https://image.tmdb.org/t/p/w500/${movie?.poster_path}`} alt={movie?.title} className='w-full h-full rounded-xl md:rounded-2xl lg:rounded-3xl object-cover object-center aspect-auto' />
        </div>
